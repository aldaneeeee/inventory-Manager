...
const categoryToIcon = {
  ...
  'Living Room': '/image/interior-design.png',
  'Bedroom': '/image/bedroom.png',
  'Bathroom': '/image/bathroom.png',
  'Other': '/image/task.png',
};
...
export default function Home() {
  ...
  const addItem = async (item, category) => {
    ...
    if (docSnap.exists()) {
      ...
      await setDoc(docRef, { quantity: (quantity || 0) + 1, category: category || '' }, { merge: true });
    } else {
        ...
        >
          ...
          <Stack width="100%" direction="row" spacing={2}>
            ...
            <Button
              ...
              size="small"
              onClick={() => {
                addItem(itemName, newItemCategory);
                setItemName('');
                setNewItemCategory('');
                handleCloseAddItem();
              }}
